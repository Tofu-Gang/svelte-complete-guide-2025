<script lang="ts">
	...
	// avoid destructuring the instance like { loading, error } = new CurrencyConverter(1, "usd", "eur");
	// accessing cc.error is a getter call, which ensures reactivity
</script>
...
{:else}
	<div class="wrapper">
		<div class="conversion">
			...
			<span class="target">{cc.rate?.toLocaleString('en-US', {
				style: 'currency',
		...
		<div class="actions">
			...
			<Button onclick={() => cc.switch()}>Switch</Button>
		</div>
	</div>
{/if}
